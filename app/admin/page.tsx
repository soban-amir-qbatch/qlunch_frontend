...
//                 <p className="text-xs sm:text-sm text-gray-600 hidden sm:block">Manage your QLunch platform</p>
//               </div>
//             </div>
...
//                   type="text"
//                   placeholder="Search..."
//                   className="pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent w-32 sm:w-auto"
//                 />
//               </div>
//               {/* Mobile search icon */}
...
//         {/* Main Content */}
//         <main className="flex-1 min-w-0 p-3 sm:p-6 lg:ml-0">
//           <AnimatePresence mode="wait">
//             <motion.div
//               key={activeTab}
//               initial={{ opacity: 0, y: 20 }}
